...
static asn_per_constraints_t asn_PER_type_NGAP_LTEM_Indication_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_NGAP_LTEM_Indication_specs_1 = {
