...
static asn_TYPE_member_t asn_MBR_NGAP_RedundantPDUSessionInformation_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_RedundantPDUSessionInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_9626P222,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_RedundantPDUSessionInformation_specs_1 = {
