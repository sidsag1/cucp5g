...
static asn_per_constraints_t asn_PER_type_NGAP_NB_IoT_DefaultPagingDRX_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_NGAP_NB_IoT_DefaultPagingDRX_specs_1 = {
