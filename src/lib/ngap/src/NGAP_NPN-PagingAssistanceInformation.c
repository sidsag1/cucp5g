...
static asn_per_constraints_t asn_PER_type_NGAP_NPN_PagingAssistanceInformation_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_NGAP_NPN_PagingAssistanceInformation_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct NGAP_NPN_PagingAssistanceInformation, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_9578P30,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_CHOICE_specifics_t asn_SPC_NGAP_NPN_PagingAssistanceInformation_specs_1 = {
