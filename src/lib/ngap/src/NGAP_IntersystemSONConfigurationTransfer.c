...
static asn_TYPE_member_t asn_MBR_NGAP_IntersystemSONConfigurationTransfer_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_IntersystemSONConfigurationTransfer, iE_Extensions),
		...
		&asn_DEF_NGAP_ProtocolExtensionContainer_9626P104,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_IntersystemSONConfigurationTransfer_specs_1 = {
